...
def start_screen(screen, clock, fps):
    ...
    running = True
    fon = pygame.transform.scale(load_image('start_screen_background_0.png', screen), (WIDTH, HEIGHT))
    screen.blit(fon, (0, 0))
    text_blit(screen)
...
def bg_blit(screen, item_bg, WIDTH, HEIGHT):
    fon = pygame.transform.scale(load_image(f'start_screen_background_{item_bg}.png', screen), (WIDTH, HEIGHT))
    screen.blit(fon, (0, 0))
